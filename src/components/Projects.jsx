    ...
    return (
        <div className="flex my-2 justify-center" id="Project">
            <div className={divProject} style={{ width: "500px", height: "200px" }}>
                <div>
                    <img src="./src/assets/img/Aerolinia.png" alt="" className="h-40 rounded w-30 object-cover object-center mx-2 my-3"/>
                </div>
                <div className="flex flex-col items-center max-w-xs break-words">
                    ...
                    <div className="flex justify-center">
                        <ul className="flex">
                            <li className="mx-1 h-12 w-12"><img src="./src/assets/ico/icons8-jwt-48.png" alt="" /></li>
                            <li className="mx-1 h-12 w-12"><img src="./src/assets/ico/icons8-logotipo-de-java-coffee-cup-50.png" alt="" /></li>
                            <li className="mx-1 h-12 w-12"><img src="./src/assets/ico/icons8-logotipo-de-primavera-48.png" alt="" /></li>
                            <li className="mx-1 h-12 w-12"><img src="./src/assets/ico/icons8-postgresql-48.png" alt="" /></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className={divProject} style={{ width: "500px", height: "200px" }}>
                <div>
                    <img src="./src/assets/img/Ajedrez.png" alt="" className="h-20 rounded w-25 object-cover object-center mx-2 my-3"/>
                </div>
